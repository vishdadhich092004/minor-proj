...
const ProductForm: React.FC = () => {
    ...
    if (hooksLoading && !products.length) return <div className="p-10">Loading form data...</div>;
    ...
    return (
        <div className="max-w-4xl mx-auto pb-10">
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h1 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">{isEditMode ? 'Edit Product' : 'Add New Product'}</h1>
                         ...
                         <div>
                            ...
                            <div className="mt-1 border rounded-md p-3 h-32 overflow-y-auto bg-white dark:bg-gray-700 dark:border-gray-600">
                                {filteredVariants.length > 0 ? (
                                    ...
                                    <p className="text-gray-500 text-sm">Select a variant type to see options</p>
                                )}
                            </div>
                        </div>
                    </div>
